...
def test_step(x):
    ...
    z, inv, _ = autoencoder(x, training=False)
    ...
    # loss = chamfer_loss
    loss = l2_loss
    return loss, l2_loss, mean_root_square, chamfer_loss, hausdorff_loss, z
...
def train_step(x):
    ...
    with tf.GradientTape() as tape:
        z, _, _ = autoencoder(x, training=True)
...
def train(trainset, valset, epochs, TEST):
    for epoch in range(epochs):
        ...
        for x in trainset:
            ...
            if TEST:
                l, l2, mrs, cl, hl, z = test_step(x)
            else:
                l, l2, mrs, cl, hl, z = train_step(x)
        ...
        print('loss: ', loss_, ' l2_loss: ', l2_loss_, ' mrs_loss ', mrs_loss_, ' chamfer_loss_l2: ', chamfer_loss_l2, ' hausdorff_loss_l2: ', hausdorff_loss_l2)
