...
class SegNetNorm(tf.keras.Model):
    def __init__(self, num_classes):
        ...
        for i in range(len(self.radius)):
            ...
            self.equivariant_weights_up.append(set_norm_activation_layers_sphere(units=self.equivariant_units_up[i],
                                                                                 l_max=self.l_max_out,
                                                                                 momentum=self.bn_momentum))
    ...
    def call(self, x):
        ...
        for i in range(len(self.radius)):
            ...
            y = apply_norm_layer(y, self.equivariant_weights[i])
        ...
        for i in range(len(self.radius)-1):
            ...
            y = apply_norm_layer(y, self.equivariant_weights_up[i])
        ...
        y = apply_norm_layer(y, self.equivariant_weights_up[-1])
        y = norms(y)
